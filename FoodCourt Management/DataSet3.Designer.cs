...
namespace FoodCourt_Management {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class STAFFDataTable : global::System.Data.TypedTableBase<STAFFRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public STAFFRow AddSTAFFRow(decimal ID, string FIRSTNAME, string MIDDLENAME, string LASTNAME, System.DateTime DOB, string DESIGNATION, decimal SALARY, string PHONE, string ADDRESS) {
...
namespace FoodCourt_Management.DataSet3TableAdapters {
    ...
    public partial class STAFFTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""DBSPROJ"".""STAFF"" WHERE ((""ID"" = :Original_ID) AND ((:IsNull_FIRSTNAME = 1 AND ""FIRSTNAME"" IS NULL) OR (""FIRSTNAME"" = :Original_FIRSTNAME)) AND ((:IsNull_MIDDLENAME = 1 AND ""MIDDLENAME"" IS NULL) OR (""MIDDLENAME"" = :Original_MIDDLENAME)) AND ((:IsNull_LASTNAME = 1 AND ""LASTNAME"" IS NULL) OR (""LASTNAME"" = :Original_LASTNAME)) AND ((:IsNull_DOB = 1 AND ""DOB"" IS NULL) OR (""DOB"" = :Original_DOB)) AND ((:IsNull_DESIGNATION = 1 AND ""DESIGNATION"" IS NULL) OR (""DESIGNATION"" = :Original_DESIGNATION)) AND ((:IsNull_SALARY = 1 AND ""SALARY"" IS NULL) OR (""SALARY"" = :Original_SALARY)) AND ((:IsNull_PHONE = 1 AND ""PHONE"" IS NULL) OR (""PHONE"" = :Original_PHONE)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"DBSPROJ\".\"STAFF\" (\"ID\", \"FIRSTNAME\", \"MIDDLENAME\", \"LASTNAME\", \"DOB\"" +
                ", \"DESIGNATION\", \"SALARY\", \"PHONE\", \"ADDRESS\") VALUES (:ID, :FIRSTNAME, :MIDDLEN" +
                "AME, :LASTNAME, :DOB, :DESIGNATION, :SALARY, :PHONE, :ADDRESS)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""DBSPROJ"".""STAFF"" SET ""ID"" = :ID, ""FIRSTNAME"" = :FIRSTNAME, ""MIDDLENAME"" = :MIDDLENAME, ""LASTNAME"" = :LASTNAME, ""DOB"" = :DOB, ""DESIGNATION"" = :DESIGNATION, ""SALARY"" = :SALARY, ""PHONE"" = :PHONE, ""ADDRESS"" = :ADDRESS WHERE ((""ID"" = :Original_ID) AND ((:IsNull_FIRSTNAME = 1 AND ""FIRSTNAME"" IS NULL) OR (""FIRSTNAME"" = :Original_FIRSTNAME)) AND ((:IsNull_MIDDLENAME = 1 AND ""MIDDLENAME"" IS NULL) OR (""MIDDLENAME"" = :Original_MIDDLENAME)) AND ((:IsNull_LASTNAME = 1 AND ""LASTNAME"" IS NULL) OR (""LASTNAME"" = :Original_LASTNAME)) AND ((:IsNull_DOB = 1 AND ""DOB"" IS NULL) OR (""DOB"" = :Original_DOB)) AND ((:IsNull_DESIGNATION = 1 AND ""DESIGNATION"" IS NULL) OR (""DESIGNATION"" = :Original_DESIGNATION)) AND ((:IsNull_SALARY = 1 AND ""SALARY"" IS NULL) OR (""SALARY"" = :Original_SALARY)) AND ((:IsNull_PHONE = 1 AND ""PHONE"" IS NULL) OR (""PHONE"" = :Original_PHONE)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FIRSTNAME, MIDDLENAME, LASTNAME, DOB, DESIGNATION, SALARY, PHONE, ADDR" +
                "ESS FROM DBSPROJ.STAFF";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OracleClient.OracleCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ID, FIRSTNAME, MIDDLENAME, LASTNAME, DOB, DESIGNATION, SALARY, PHONE, ADDR" +
                "ESS FROM DBSPROJ.STAFF";
        ...
        public virtual int FillBy(DataSet3.STAFFDataTable dataTable) {
        ...
        public virtual int Delete(decimal Original_ID, string Original_FIRSTNAME, string Original_MIDDLENAME, string Original_LASTNAME, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_DESIGNATION, global::System.Nullable<decimal> Original_SALARY, string Original_PHONE, string Original_ADDRESS) {
        ...
        public virtual int Insert(decimal ID, string FIRSTNAME, string MIDDLENAME, string LASTNAME, global::System.Nullable<global::System.DateTime> DOB, string DESIGNATION, global::System.Nullable<decimal> SALARY, string PHONE, string ADDRESS) {
        ...
        public virtual int Update(
                    ...
                    string Original_PHONE, 
                    string Original_ADDRESS) {
            return this.Update(Original_ID, FIRSTNAME, MIDDLENAME, LASTNAME, DOB, DESIGNATION, SALARY, PHONE, ADDRESS, Original_ID, Original_FIRSTNAME, Original_MIDDLENAME, Original_LASTNAME, Original_DOB, Original_DESIGNATION, Original_SALARY, Original_PHONE, Original_ADDRESS);
        }
    }
